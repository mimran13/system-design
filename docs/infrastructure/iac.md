...
- [CI/CD](cicd.md) — IaC applied by the pipeline
- [Containers](containers.md) — what IaC provisions runs containers
- [Secrets Management](../security/secrets-management.md) — reference secrets, don't embed
- [Kubernetes](kubernetes.md) — Helm + Kustomize as IaC for K8s
