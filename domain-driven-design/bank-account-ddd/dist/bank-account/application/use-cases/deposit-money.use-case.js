...
let DepositMoneyUseCase = class DepositMoneyUseCase {
    accountRepo;
    transactionRepo;
    eventEmitter;
    ...
    async execute(command) {
        ...
        return (0, with_optimistic_retry_1.withOptimisticRetry)(() => this.tryDeposit(accountId, amount, command.description));
    }
    async tryDeposit(accountId, amount, description) {
        ...
        const transaction = transaction_entity_1.Transaction.create({ accountId, type: 'DEPOSIT', amount, description });
...
exports.DepositMoneyUseCase = DepositMoneyUseCase = __decorate([
...
//# sourceMappingURL=deposit-money.use-case.js.map